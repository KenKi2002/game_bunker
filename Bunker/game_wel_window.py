...
"")
        ...
        self.create_game.setGeometry(QtCore.QRect(289, 360, 322, 81))
        self.create_game.setObjectName("create_game")
        self.enter_game = QtWidgets.QPushButton(self.centralwidget)
        self.enter_game.setGeometry(QtCore.QRect(289, 460, 322, 81))
...
"background: rgba(255, 255, 255, 0.7);")
        ...
        self.prof_img.setPixmap(QtGui.QPixmap("/Game_bunker/templates/users/def_prof_img.png"))
